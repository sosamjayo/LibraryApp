<script lang="ts">
	...
	import { Button, GradientButton, Card } from 'flowbite-svelte';
...
<div class="center-container">
    {#if !show}
	    <Button on:click={()=>{show=true}} color="primary" variant="contained">Show Profile Card!</Button>
    {:else}
...
<style>
	.center-container {
		...
		align-items: center;
		min-height: 100vh;
		background: linear-gradient(135deg, #622774 0%, #c53364 50%, #705898 100%);
	}
</style>
